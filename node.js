...
async function fetchPhoto(pageNum){
    if(document.getElementById("query").value!="" && orient!=''){
        ...
        for (const result of results) {
            ...
            document.getElementById("imageGallery").innerHTML+=`<div class="imageFrame"><img src="${result.urls.small}"><div class="downloadLogo"><a href="${result.urls.raw.split("&")[0].split("?")[0]}" target="_blank" download="${timecurrent}.jpg"><i class="fa-solid fa-download" color="white"></i></a></div></div>`;
        }
